...
public:
	...
	HRESULT GetstExeceptionInfo(TcMgSdk::ExceptionInfo& stParam);
	static void _GetstExeceptionInfo(ST_GetSet_ST_ExceptionInfo* ST_Param);
...
TYPESIZE_VALIDATION2(CFbTcComExceptionGenerator,568,600);
