...
BEGIN_OBJDATAAREA_MAP(CTcComExceptionGenerator)
	OBJDATAAREA_SPAN_PTR_SIZE_FLAGS( 0, 1, &(ExceptionGenerator_Obj.ExceptionGenerator_U), sizeof(ExceptionGenerator_Obj.ExceptionGenerator_U), 0)
	OBJDATAAREA_SPAN_PTR_SIZE_FLAGS( 1, 1, &(ExceptionGenerator_Obj.ExceptionGenerator_Y), sizeof(ExceptionGenerator_Obj.ExceptionGenerator_Y), OBJDATAAREA_DISABLE_SET)
	OBJDATAAREA_SPAN_PTR_SIZE_FLAGS( 2, 1, &(ExceptionGenerator_Obj.ExceptionGenerator_DW), sizeof(ExceptionGenerator_Obj.ExceptionGenerator_DW), OBJDATAAREA_DISABLE_SET)
